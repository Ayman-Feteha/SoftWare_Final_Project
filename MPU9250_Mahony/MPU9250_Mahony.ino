...
//acel offsets and correction matrix
 float A_B[3] {  9.54,   53.60,  -39.20}; 
 float A_Ainv[3][3]
  {{ 17.79364, -0.06410, -0.14825},
             { -0.06410, 18.16404,  0.51194},
             { -0.14825,  0.51194, 17.11187}};
  
// mag offsets and correction matrix
  float M_B[3]
 {    10.16,  259.86, 6699.50};
 float M_Ainv[3][3]
  {{  1.92506,  0.00639,  0.00259},
             {  0.00639,  1.95262, -0.00192},
             {  0.00259, -0.00192,  1.94800}};
  
  float G_off[3] = {22.1, 217.9, -185.8}; //raw offsets, determined for gyro at rest
// ^^^^^^^^^^^^^^^^^^^ VERY VERY IMPORTANT ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
