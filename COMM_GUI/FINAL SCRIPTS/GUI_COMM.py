...
check_joy="OFF"             #This flag changes whenever the joystick connection is disturbed      
#imu reading 
pitch = 30
yaw = 20
roll = 50
...
btn_states=[0,0,0,0,0]      #states of grippers and light
...
def ROVcb(data):            #Callback function for msg recieved from ROV
    ...
    global last_recieved_msg
                            #making sure not to display the same reading more than once
...
class Publisher():          #This class initialises the station publisher node
    def __init__(self):
        ...
        self.pub=rospy.Publisher("/toROV",String,queue_size=1)
...
def GUI():
    ...
    #----------------------graph------------------------
            ...
            self.show()
                                                #This function updates the data displayed on the gui screen
                                                #It connects the GUI code with the communication code
    ...
    #-------------------------thrust--------------------------------
            ...
            painter.drawArc(30, 30, 150, 150, -90 * 16, -int(abs(thrust_FR) /maxspeed *360* 16))
            painter.drawArc(250, 30, 150, 150, -90 * 16, -int(abs(thrust_FL) /maxspeed *360* 16))
            painter.drawArc(470, 30, 150, 150, -90 * 16, -int(abs(thrust_TF) /maxspeed *360* 16))
            painter.drawArc(690, 30, 150, 150, -90 * 16, -int(abs(thrust_TB) /maxspeed *360* 16))
            painter.drawArc(910, 30, 150, 150, -90 * 16, -int(abs(thrust_BR) /maxspeed *360* 16))
            painter.drawArc(1130, 30, 150, 150, -90 * 16, -int(abs(thrust_BL) /maxspeed *360* 16))
